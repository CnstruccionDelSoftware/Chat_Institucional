...
var DaoImplMessage = (function () {
    ...
    DaoImplMessage.prototype.createMessage = function (entity, username) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    DaoImplMessage.prototype.modify = function (entity) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, Message_1.Message.findOneAndReplace({ _id: entity._id })];
                    case 1:
                        message = _a.sent();
                        return [2, message];
                }
    ...
    DaoImplMessage.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, Message_1.Message.find()];
                    case 1:
                        messages = _a.sent();
                        return [2, messages];
                }
    ...
    DaoImplMessage.prototype.findAllWithCourseId = function (courseId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, Message_1.Message.find({ id_course: courseId })];
                    case 1:
                        messages = _a.sent();
                        return [2, messages];
                }
